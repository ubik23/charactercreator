...
function launch() {
    ...
    var femaleForm2 = {
      ...
      'Glasses': ['', 'alien', 'designer', 'fpv', 'goggles', 'google', 'hipster', 'oakley', 'rayban', 'round', 'wayrafer'],
      'Headband': ['', 'medium'],
      'Hat': ['', 'baseball', 'beach', 'top', 'waitress', 'cowboy', 'police', 'scumbag', 'helmet_vietnam', 'tiara', 'strainer', 'magritte', 'motorcycle', 'tuque', 'cap'],
    ...
    var layersFemale = [
      ...
      'headband_medium_1_of_2',
      'hat_baseball', 'hat_beach_1_of_2', 'hat_waitress','hat_police','hat_cowboy','hat_top','hat_scumbag','hat_tiara','hat_magritte','hat_strainer_1_of_2','hat_helmet_vietnam_1_of_2','hat_tuque','hat_cap','hat_motorcycle',
      'body_hand',
