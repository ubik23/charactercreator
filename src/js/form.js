function createForm(sex, forms) {
  ...
  for (var f in forms) {
    ...
    sectionHtml +=
      '<section class="accordeon__section-label"><span class="accordeon__section-title"><svg class="icon"><use xlink:href="#' +
    ...
    for (var x in forms[f]) {
      sectionHtml +=
        '    <a class="section__link"><li class="sbl__option" tabindex="0">' +
        x +
        "</li></a>";
      var sectionTitle = x;
