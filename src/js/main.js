window.onload = function () {
  ...
  if (braveAffiliateBtn && typeof gotoBrave === "function") {
    braveAffiliateBtn.addEventListener("click", gotoBrave, false);
  }
  if (newCharBtn && typeof gotoNewChar === "function") {
    newCharBtn.addEventListener("click", gotoNewChar, false);
  }
  if (saveCharToCloudBtn && typeof saveCharToCloud === "function") {
    saveCharToCloudBtn.addEventListener("click", saveCharToCloud, false);
  }
  ...
  if (bigRedBtn && typeof smartRandomSingle === "function") {
    bigRedBtn.addEventListener("click", smartRandomSingle, false);
  }
...
function gotoBrave(evt) {
  ...
  ga("send", "event", {
    eventCategory: "Conversion",
    eventAction: "Caboose | Brave",
    eventLabel: "Open Brave Browser page from Caboose modal.",
  });
  closeAllOverlays();
  consolelog("brave");
  setTimeout(function () {
    window.open("https://brave.com/cha553");
  }, 500);
}
...
function clickSelect(ev) {
  ...
  if (formSection > -1) {
    ...
    isClosed = sectionList[formSection].nextSibling.classList.contains(
      "section--hide"
    );
    ...
    if (prefixIndex > -1) {
      itemButtonList = sectionList[formSection].nextSibling.querySelectorAll(
        "li.sbl__option"
      );
