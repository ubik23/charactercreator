...
function getViewBox (t, d) {
  ...
  if (sex === 'm') {
    ...
    var idDict = {
      armband_bandage_right: '205 229 42 42',
      armband_bandage_left: '309 259 53 53',
      armband_egyptian_right: '208 186 41 41',
      armband_egyptian_left: '303 206 41 41',
      smoke_blunt: '283 147 20 20',
      body_athletic: '65 130 430 430',
      bracelet_wonder_right: '202 223 51 51',
      bracelet_wonder_left: '308 267 51 51',
      bracelet_band_right: '224 248 28 28',
      bracelet_band_left: '323 298 30 30',
      bracelet_egyptian_right: '203 221 52 52',
      bracelet_egyptian_left: '309 266  51 51',
      bracelet_ornamental_right: '218 244 36 36',
      bracelet_ornamental_left: '322 291 32 32',
      bracelet_perl_right: '198 299 24 24',
      bracelet_perl_left: '322 272 24 24',
      bracelet_rings_right: '206 230 51 51',
      bracelet_rings_left: '318 279 39 39',
      ...
      kneepads_skate : '220 323 132 132',
      ...
      scar_vertical_right: '264 110 32 32',
      scarf_drape: '185 140 190 190',
      shoes_cowboy: '226 412 132 132',
      shoes_flops: '228 414 132 132',
      shoes_hightops: '229 413 132 132',
      shoes_highheels: '226 414 132 132',
      shoes_moon: '229 415 132 132',
      shoes_sandals_roman: '227 412 132 132',
      ...
      underwear_boxers: '224 258 120 120',
      wings_angel: '-56 -175 679 679',
      wings_skeleton: '33 -83 495 495'
    }
    var sectionDict = {
      age: '261 121 40 40',
