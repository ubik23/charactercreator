var maleForm1 = {
  ...
  Hair: ['', 'afro', 'balding', 'balding_crazy', 'balding_crown', 'buzzcut', 'crewcut', 'down', 'emo', 'faux_hawk', 'fringes', 'spider', 'gelled', 'wavy', 'manga', 'mohawk', 'pushed_back', 'quiff', 'side_parted', 'undercut', 'wild', 'wreckingball'],
  Freckles: ['', 'medium'],
...
var femaleForm3 = {
  ...
  Shirt: ['', 'collar', 'jersey_long-sleeved_striped', 'sleeveless_sfl', 'sweat', 'tshirt', 'structured_smart'],
  Button: ['', 'heart', 'peace', 'smile'],
  Shoulderpads: ['', 'artillery', 'general', 'plated', 'spikes'],
...
var femaleForm5 = {
  ...
  Pants: ['', 'cargo', 'yoga', 'yoga_torn', 'jeans', 'jeans_rolled', 'jeans_torn', 'jeans_bellbottoms', 'trousers_smart'],
  Belt: ['', 'bullet', 'utility', 'satchel']
}
var femaleForm6 = {
  Leggings: ['', 'fishnet', 'regular', 'striped', 'torn'],
  Kneepads: ['', 'skate'],
  Shoes: ['', 'boots_heeled', 'brogues', 'cowboy', 'flip-flops', 'hightops', 'highheels', 'moon', 'plateforms', 'sandals_roman'],
  Pet: ['', 'feline', 'raven', 'rat', 'canine', 'siamese_cat', 'gerbil', 'chicken', 'fox', 'vulture', 'parrot', 'doge']
}
