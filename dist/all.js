...
function createForm(sex){
    ...
    for (var f in forms){
        ...
        if (f == 0 ){
            ...
            newHtml += '<svg class="play-button" onclick="playRandom = setInterval(random, 250);" width="25" height="25" viewBox="0 0 1024 1024"><path class="path1" d="M192 128l640 384-640 384z"></path></svg>';
